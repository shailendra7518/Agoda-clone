...
export const ProductPage = () => {
    ...
    const handlereview = () => {
      axios
        .get("https://blooming-brook-61650.herokuapp.com/findhotels?_sort=reviews&_order=desc")
        .then((res) => {
          console.log("result=", res.data);
          dispatch(getDataSuccess(res.data));
        });
    ...
    const handlerate = () => {
      axios
        .get("https://blooming-brook-61650.herokuapp.com/findhotels?_sort=rating&_order=desc")
        .then((res) => {
          console.log("result=", res.data);
          dispatch(getDataSuccess(res.data));
        });
    ...
    const handlechangecheck = () => {
      axios
        .get("https://blooming-brook-61650.herokuapp.com/findhotels?_sort=distance&_order=desc")
        .then((res) => {
          console.log("result=", res.data);
          dispatch(getDataSuccess(res.data));
        });
    ...
    const searchData = () => {
      ...
      return axios
        .get(
          `https://blooming-brook-61650.herokuapp.com/findhotels?city=${searchedCity}`
        )
        .then((res) => {
     ...
     */}
              <Box className={styles.root}>
                <Box className={styles.root1}>
                  <ProductLeftPage handlechangecheck={handlechangecheck} />
                </Box>
